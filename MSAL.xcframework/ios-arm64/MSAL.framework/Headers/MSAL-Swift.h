...
///
- (void)onAccessTokenRetrieveCompletedWithAccessToken:(NSString * _Nonnull)accessToken;
@end
...
typedef SWIFT_ENUM(NSInteger, MSALNativeAuthChannelType, open) {
/// Specifies if the channel type is Email
  MSALNativeAuthChannelTypeEmail = 0,
/// Specifies if the channel type is Phone
  MSALNativeAuthChannelTypePhone = 1,
};
...
@property (nonatomic, readonly, strong) MSALAccount * _Nonnull account;
...
/// \param forceRefresh Ignore any existing access token in the cache and force MSAL to get a new access token from the service.
///
/// \param correlationId Optional. UUID to correlate this request with the server for debugging.
///
...
///
- (void)onResetPasswordResendCodeRequiredWithNewState:(ResetPasswordCodeRequiredState * _Nonnull)newState sentTo:(NSString * _Nonnull)sentTo channelTargetType:(enum MSALNativeAuthChannelType)channelTargetType codeLength:(NSInteger)codeLength;
@end
...
/// \param codeLength The length of the code required.
///
- (void)onResetPasswordCodeRequiredWithNewState:(ResetPasswordCodeRequiredState * _Nonnull)newState sentTo:(NSString * _Nonnull)sentTo channelTargetType:(enum MSALNativeAuthChannelType)channelTargetType codeLength:(NSInteger)codeLength;
@end
...
/// Returns <code>true</code> if the existing token cannot be found.
@property (nonatomic, readonly) BOOL isTokenNotFound;
@end
...
/// \param codeLength The length of the code required.
///
- (void)onSignInResendCodeCodeRequiredWithNewState:(SignInCodeRequiredState * _Nonnull)newState sentTo:(NSString * _Nonnull)sentTo channelTargetType:(enum MSALNativeAuthChannelType)channelTargetType codeLength:(NSInteger)codeLength;
@end
...
/// \param codeLength The length of the code required.
///
- (void)onSignInCodeRequiredWithNewState:(SignInCodeRequiredState * _Nonnull)newState sentTo:(NSString * _Nonnull)sentTo channelTargetType:(enum MSALNativeAuthChannelType)channelTargetType codeLength:(NSInteger)codeLength;
/// Notifies the delegate that a password is required from the user to continue.
/// note:
/// If a flow requires this optional method and it is not implemented, then <code>onSignInStartError(error:)</code> will be called.
/// \param newState An object representing the new state of the flow with follow on methods.
...
/// \param codeLength The length of the code required.
///
- (void)onSignUpResendCodeCodeRequiredWithNewState:(SignUpCodeRequiredState * _Nonnull)newState sentTo:(NSString * _Nonnull)sentTo channelTargetType:(enum MSALNativeAuthChannelType)channelTargetType codeLength:(NSInteger)codeLength;
@end
...
/// \param codeLength The length of the code required.
///
- (void)onSignUpCodeRequiredWithNewState:(SignUpCodeRequiredState * _Nonnull)newState sentTo:(NSString * _Nonnull)sentTo channelTargetType:(enum MSALNativeAuthChannelType)channelTargetType codeLength:(NSInteger)codeLength;
/// Notifies the delegate that invalid attributes were sent.
/// note:
/// If a flow requires this optional method and it is not implemented, then <code>onSignUpStartError(error:)</code> will be called.
/// \param attributeNames List of attribute names that failed validation.
